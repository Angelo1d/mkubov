...
def laba1():
    ...
    tab1_label = tk.Label(tab1, text = "Моя перша програма", fg="red", font = ("Arial Bold", 20), bg = "purple", width=300, height=2)
    tab1_label.pack()
    btn = Button(tab1, text="Click Me", padx="200", pady="2", font="12", command=_quit)
    btn.pack()


    tab2_label = tk.Label(tab2, text = "Hello, world", fg="red", font = ("Arial Bold", 20), bg = "purple", width=300, height=2)
    ...
    tab3_label = tk.Label(tab3, text = "Киньте кубик", fg="red", font = ("Arial Bold", 20), bg = "purple", width=300, height=2)
    ...
    tab4_label = tk.Label(tab4, text = "Введіть новий заголовок", fg="red", font = ("Arial Bold", 20), bg = "purple", width=300, height=2)
    tab4_label.pack()
    message = StringVar()
...
def laba2():
    ...
    traffic = tk.LabelFrame(tab1, text=' Світлофор ')
